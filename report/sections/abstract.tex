\begin{abstract}
    ...
    of two castes of ants in particular -- the \textit{minor} and \textit{major} -- worker ants within a colony have on that colony's overall ability to forage for food when faced with differing conditions.

    %Methods
    An ant colony is simulated in Matlab on terrain that has been descritised into chunks, and food is spawned randomly throughout the terrain. Ant colonies with differing ratios of simulated
    ...
    to identify the most sucessfull distribution of minor and major worker ants.
    ...
    successful, reflecting the average distribution of minor to major worker ants seen in real-world mature nests as measured in a previously published work\cite{Tschinkel1988}.
\end{abstract}
