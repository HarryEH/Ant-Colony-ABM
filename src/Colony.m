...
classdef Colony < handle
    ...
    methods     
        ...
        % Function that handles ant generation.
        function generateAnts(self, ratio, total_ants)
            ...
            number_of_scouts = floor(total_ants*(1-ratio));
            number_of_workers = floor(total_ants * (ratio));
